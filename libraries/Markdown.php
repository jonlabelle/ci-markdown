...
class Markdown
{
	 ...
	 * phrase emphasis, and spans.
	 *
	 * The list of tags we're looking for is hard-coded:
	 *
	 * - List "a" is made of tags which can be both inline or block-level. These
	 *   will be treated block-level when the start tag is alone on its line,
	 *   otherwise they're not matched here and will be taken as inline later.
	 *
	...
	/**
	 * Markdown links callback function.
	 *
	 * @param   array $matches
	 * @return  string
	 */
